  ...
  <div>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
      <div class="container d-flex align-items-center justify-content-between">
        <div class="logo">
          <h1>
            <a href="index.html">My<span>Biz</span></a>
          </h1>
    ...
    <section id="hero">
      <div class="hero-container">
        ...
        >
          ...
          >
            <span
              class="carousel-control-prev-icon ri-arrow-left-line"
              aria-hidden="true"
            ></span>
          </a>
          ...
          >
            <span
              class="carousel-control-next-icon ri-arrow-right-line"
              aria-hidden="true"
            ></span>
          </a>
        </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div
              ...
              style="background-image: url('assets/img/about-list-img.jpg')"
            ></div>
          </div>
        </div>
      </section>
    ...
    <footer id="footer">
      ...
      <div class="container">
        <div class="copyright">
          &copy; Copyright <strong><span>MyBiz</span></strong
          >. All Rights Reserved
        </div>
        <div class="credits">
